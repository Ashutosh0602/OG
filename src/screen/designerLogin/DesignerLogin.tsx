...
function DesignerLogin() {
  return (
    ...
    >
      ...
      <div className="py-12">
        <div style={{ fontSize: "1.25rem", fontWeight: 600 }}>Anjali Dubey</div>
        <div style={{ width: "calc(60%)" }}>
          Hi, I'm Anjali Dubey, a passionate and imaginative designer weaving
          stories through visuals. With a natural inclination for aesthetics and
          meticulous attention to detail, I bring ideas to life in the most
          visually compelling way possible. My design journey is a fusion of
          creativity and professionalism, embracing graphic design, UX/UI, and
          multimedia. Every project is a canvas for innovation, where I
          ...
          of creativity, I'm dedicated to pushing boundaries and shaping designs
          that inspire.
        </div>
        <div>
          <Button
